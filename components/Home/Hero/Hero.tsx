            ...
            <div className="absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%]  translate-y-[-50%]">
                <div className="flex items-center justify-center flex-col w-full h-full">
                    <div data-aos="fade-up">
                        <h1 
                        className="text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] traking-[0.7rem]
                ...
                {/**search box */}
                <SearchBox />
                <a href="#" className="rounded px-14 md:px-28 -mt-4 py-2.5 overflow-hidden group bg-rose-600 
                                        ...
                                        >
                    <span className="absolute right-0 w-8 h-32 -mt-12 transition-all duration-100 transform 
